...
public class EmployeeDAO extends DAO{
    public EmployeeDAO(){
        getAllSQL = "select EmployeeID, EmployeeName, EmployeeImage, EmployeeGender, EmployeeAddress, EmployeePhone, EmployeeWage " +
                    "from EMPLOYEE ";
    ...
    public boolean insertItem(DTO dto) {
        ...
        try {
            ...
            pstm.setBytes(3,((EmployeeDTO) dto).getEmployeeImage());
    ...
    public boolean updateItem(DTO dto) {
        ...
        try {
            ...
            pstm.setBytes(2,((EmployeeDTO) dto).getEmployeeImage());
