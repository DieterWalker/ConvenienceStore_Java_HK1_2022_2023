...
public class EmployeeDTO extends DTO {
    String EmployeeName, EmployeeAddress, EmployeePhone, EmployeeGender;
    int  EmployeeID,  EmployeeWage;
    byte[] EmployeeImage;

    public EmployeeDTO() {
    }

    public EmployeeDTO(String EmployeeName, String EmployeeAddress, String EmployeePhone, int EmployeeID, String EmployeeGender, int EmployeeWage, byte[] EmployeeImage) {
    ...
    public boolean retriveData(ResultSet rs) {
        ...
        try {
            ...
            this.EmployeeImage= rs.getBytes(3);
