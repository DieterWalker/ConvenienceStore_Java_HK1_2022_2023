...
public class ReceiptScreen extends JFrame {
    ...
    JLabel labEmployeeName, labCustomerPhone, labDate, labReceiptDetail, 
           ...
           labProductAmount, labPicture;
    JTable tabReceiptDetailData, tabProductData;
    ...
    String[][] tabData = {
        {"ProductID" , "ProductName",  "Amount", "TotalPrice" }
    };
       
    String[] ProductDataColumn = {"Product ID", "Product Name", "Category", "Price", "Storage"};
    String[][] ProductData = {{"Product ID", "Product Name", "Category", "Price", "Storage"}};
    
    String[] tabDataColumn = {"ProductID" , "ProductName",  "Amount", "TotalPrice" }; 
    ...
    private void CreateRight(){
        ...
        tabReceiptDetailData = new JTable(tabData, tabDataColumn);
            tabReceiptDetailData.setVisible(true);
