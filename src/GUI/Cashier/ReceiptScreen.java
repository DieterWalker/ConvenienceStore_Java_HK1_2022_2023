...
public class ReceiptScreen extends JFrame {
    ...
    private void ReceiptGUI(){
        CreateLeft();
        CreateRight();        
        FindID(tabReceiptDetailData,txtReceiptID);
    }
...
//                            if(Cdto.ProductID.contains(Integer.parseInt(txtProductID.getText())))
//                                dto = Cdto;
//                        }
//                        txtProductID.setText(Integer.toString(dto.ProductID));
//                        tx
                    }
            });
            ...
            btnCancel.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if ( flag == 1 ){
                            ReceiptManagerLogic logic = new ReceiptManagerLogic();
                            logic.dto.ReceiptID = Integer.parseInt(txtEmployeeID.getText());
                            logic.Remove();}
                        flag = 0;
                        new CashierScreen();
                        dispose();
