    ...
    private void GUI(){ 
        ...
        tabAccount.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent evt) {
                    ...
                    if (row >= 0 ){
                    txtAccountID.setText(Integer.toString((int) tabAccount.getValueAt(row,0)));
                    cbbEmployeeID.setSelectedItem((int)tabAccount.getValueAt(row, 1));
                    txtAccountUserName.setText((String)tabAccount.getValueAt(row,2));
                    txtAccountPassword.setText((String)tabAccount.getValueAt(row,3));
                    if (tabAccount.getValueAt(row,4).equals("Accountant") )
                        radAccountant.setSelected(true);
                    else if (tabAccount.getValueAt(row,4).equals("Cashier") )
            ...
            btnAdd.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        logic.dto.EmployeeID = (int)cbbEmployeeID.getSelectedItem();
                        ...
                        JOptionPane.showMessageDialog(manager, "Account added successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);
                        Clear();
                        Show();
                    }
            });  
            ...
            btnDelete.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        AccountManagerLogic logic = new AccountManagerLogic();
                        int id;
                        id = Integer.parseInt(txtAccountID.getText());
                        logic.dto.AccountID = id;
                        logic.Remove();
                        JOptionPane.showMessageDialog(manager, "Account deleted successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);
                        Clear();
                        Show();
                        //add code before clear
                        Clear();
            ...
            btnEdit.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        String M = "Manager";
                        if ( radAccountant.isSelected() == true ){
                            logic.dto.Position = A;
                        }
                        
                        if ( radCashier.isSelected() == true ){
                            logic.dto.Position = C;
                        }
                         
                        if ( radManager.isSelected() == true ){
                            logic.dto.Position = M;
                        }
                        ...
                        JOptionPane.showMessageDialog(manager, "Account edited successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);    
                        Clear();
                        Show();
                        //add code before clear
                        Clear();
            ...
            btnSearch.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (AccountDTO Cdto : logic.list){
                            if(Cdto.Username.contains(txtSearch.getText().trim()))
                                list.add(Cdto);
                        }
                        tableModel.setRowCount(0);
                        for(AccountDTO dto : list){
                            tableModel.addRow(new Object[]{dto.getAccountID(), dto.getEmployeeID(), dto.getUsername(),dto.getPassword(),dto.getPosition()});
                        }
                        ReturnWhite();
                    }
            });
