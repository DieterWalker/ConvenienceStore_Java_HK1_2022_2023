        ...
        btnAdd.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        JOptionPane.showMessageDialog(manager, "Category added successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);    
                        Clear();
                        Show();
                    }
            });  
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (CategoryDTO Cdto : logic.list){
                            ...
                            if (txtCategoryID.getText().trim().equalsIgnoreCase(n)){
                                ...
                                flag = 1;
                                break;
//                                if (txtCategoryName.getText().trim().equalsIgnoreCase(Cdto.CategoryName))
//                                        flag = 0;
                            }                            
                        }
                        if(flag==1)
                            ...
                            JOptionPane.showMessageDialog(manager, "Information is wrong or duplicated!" , "Error",  JOptionPane.INFORMATION_MESSAGE);
                            return;
                        }
        ...
        btnSearch.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (CategoryDTO Cdto : logic.list){
                            if(Cdto.CategoryName.contains(txtSearch.getText().trim()))
                                list.add(Cdto);
                        }
