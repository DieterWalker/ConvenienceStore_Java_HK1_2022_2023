            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        JOptionPane.showMessageDialog(manager, "Sale added to database successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);
                        Clear();
                        Show(); 
                    }
            });  
            ...
            btnEdit.addActionListener(new ActionListener() {
                @Override
                    public void actionPerformed(ActionEvent e) {
                        ...
                        JOptionPane.showMessageDialog(manager, "Sale edited successfully!" , "Done!",  JOptionPane.INFORMATION_MESSAGE);    
                        Clear();
                        Show();
                        //add code before clear
                        Clear();
